...
class _StudentMainPageState extends State<StudentMainPage> {
 ...
 void _startQuiz(BuildContext context, Map<String, dynamic> quizData, String quizId) async {
  ...
  final questions = questionSnap.docs
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text('STUDENT', style: titleStyle(textColor: Colors.black, fontSize: 16)),
              ),

              const SizedBox(height: 32),

              Text('Hi, ${_user.email ?? 'Student'}!',
                  style: titleStyle(textColor: Colors.black, fontSize: 24)),
              const SizedBox(height: 4),
              const Text('Select a quiz to begin.',
  ...
  return FutureBuilder<QuerySnapshot>(
    future: FirebaseFirestore.instance
        ...
        .get(),
    builder: (context, snapshot) {
      final questionCount = snapshot.data?.docs.length ?? 0;
